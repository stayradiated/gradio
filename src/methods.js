...
Methods = (function() {
  ...
  */
  ...
  Methods.prototype.markStreamKeyOver30Seconds = function(ip, streamKey, songID, artistID) {
    var parameters;
    ...
    return this.core.callMethod(parameters, 'markStreamKeyOver30Seconds');
  };
  ...
  */
  ...
  Methods.prototype.getSongUrl = function(songID) {
    ...
    this.core.country.fetch().then(function(country) {
      ...
      return _this.core.callMethod(parameters, 'getStreamKeyFromSongIDEx');
  ...
  */
  ...
  Methods.prototype.getSongStream = function(songID) {
    var deferred, ip, streamKey, timer,
      _this = this;
    ...
    this.getSongUrl(songID).then(function(response) {
      ...
      timer = setTimeout(function() {
        ...
        return this.markStreamKeyOver30Seconds(ip, streamKey, songID).then(function(response) {
          return console.log('\n', response, '\n');
        });
      }, 30 * 60 * 1000);
